...
class Visualizer:
    ...
    def overlay_instances(self, label_map, id_to_class_name_map, image_name, alpha=0.5):
        """
        Args:
        ...
        for label_idx in np.unique(label_map):
            ...
            #print("This is image name ", image_name)

            for polygon_verts in polygons:
                #print('Polygon verts: ', polygon_verts)
                if text == "road":
                    #print('Polygon verts: ', polygon_verts)
                    coordinates.append(polygon_verts)
